...
(test-eq '()   (gpio-number-lookup "P8_1"))
(test-eq '()   (gpio-number-lookup "P8_2"))
...
(test-eq '()   (gpio-number-lookup "P9_1"))
(test-eq '()   (gpio-number-lookup "P9_2"))
(test-eq '()  (gpio-number-lookup "P9_3"))
(test-eq '()   (gpio-number-lookup "P9_4"))
(test-eq '()   (gpio-number-lookup "P9_5"))
(test-eq '()   (gpio-number-lookup "P9_6"))
(test-eq '()   (gpio-number-lookup "P9_7"))
(test-eq '()   (gpio-number-lookup "P9_8"))
(test-eq '()   (gpio-number-lookup "P9_9"))
(test-eq '()   (gpio-number-lookup "P9_10"))
...
(test-eq '()   (gpio-number-lookup "P9_32"))
(test-eq '()   (gpio-number-lookup "P9_33"))
(test-eq '()   (gpio-number-lookup "P9_34"))
(test-eq '()   (gpio-number-lookup "P9_35"))
(test-eq '()   (gpio-number-lookup "P9_36"))
(test-eq '()   (gpio-number-lookup "P9_37"))
(test-eq '()   (gpio-number-lookup "P9_38"))
(test-eq '()   (gpio-number-lookup "P9_39"))
(test-eq '()   (gpio-number-lookup "P9_40"))
(test-eq 20  (gpio-number-lookup "P9_41"))
(test-eq 7   (gpio-number-lookup "P9_42"))
(test-eq '()   (gpio-number-lookup "P9_43"))
(test-eq '()   (gpio-number-lookup "P9_44"))
(test-eq '()   (gpio-number-lookup "P9_45"))
(test-eq '()   (gpio-number-lookup "P9_46"))
